...
// Fungsi helper untuk format harga sebagai string
function formatHarga(harga) {
    return "Rp " + harga.toLocaleString("id-ID");
}

// Load dataTracking dari localStorage jika ada, atau gunakan default
var dataTracking = JSON.parse(localStorage.getItem("dataTracking")) || {
    "20230012": {
        nomorDO: "20230012",
        nama: "Rina Wulandari",
